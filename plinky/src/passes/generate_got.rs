...
pub(crate) fn generate_got(ids: &mut SerialIds, object: &mut Object) {
    ...
    let placeholder: &[u8] = match object.env.class {
        plinky_elf::ElfClass::Elf32 => &[0; 4],
        plinky_elf::ElfClass::Elf64 => &[0; 8],
    };
    ...
    for symbol in symbols {
        ...
        offsets.insert(symbol, offset as _);
    }
...
pub(crate) struct GOT {
    ...
    pub(crate) offsets: BTreeMap<SymbolId, u64>,
}

impl GOT {
    pub(crate) fn offset(&self, symbol: SymbolId) -> u64 {
